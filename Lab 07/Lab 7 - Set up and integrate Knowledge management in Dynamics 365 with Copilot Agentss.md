...
**Introduction :** This lab guide focuses on configuring Knowledge Management in Dynamics
...
11. Set the toggle for **Turn on automatic search**.
...
9.  Wait for a few seconds. Your agent is created successfully.

    ![](./media/0e488915dacc8b6354c9c7ec99c7d195099e36ee.png)
...
6.  Select **Save** from top right corner.
    ...
    ![](./media/735a2f75de3ae638a62de857d01743a018c901e3.png)
...
2.  Select **Search Dynamics 365 knowledge article flow** action.
    ...
    ![](./media/44132d2914e7c795b1a15b8b682e111cc4e04cd6.png)
...
5.  Repeat the same process on **Filter Input** and select
    **Activity.Recipient.ID** variable.
    ...
    ![](./media/8f6ac2e1eeefd65f6976f542e9dc51f968763b21.png)
...
7.  On the **Message** node click on the **{X} add variable** button and
    ...
    ![](./media/d302681c14bc871711e11a8c288f1a51c3656b76.png)

8.  From top right corner click on the **Save** button to save the
    topic.

    ![](./media/812a7d28168cf00375b37b769493b54aaa43ff2f.png)
