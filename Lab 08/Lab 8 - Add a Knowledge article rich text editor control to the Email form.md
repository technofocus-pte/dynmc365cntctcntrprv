# Lab 8 - Add a Knowledge article rich text editor control to the Email formAdd a Knowledge article rich text editor control to the Email form

**Introduction :** This lab guide focuses on updating the Email form in Power Apps by
...
## Exercise 1 - Add a Knowledge article Rich Text Editor control to the
Email form
