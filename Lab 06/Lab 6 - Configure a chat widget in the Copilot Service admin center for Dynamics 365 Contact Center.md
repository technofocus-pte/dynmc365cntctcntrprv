...
**Introduction :** This lab guide focuses on creating and configuring a chat widget in the
...
35. Turn on Authentication settings and open the dropdown under
    **Authentication name** and review the **Create authentication
    setting** option.
