...
8.  On the verification page, set **Country/Region** to **United States**.
...
4.  From the left navigation pane, expand **Users** and select **Active
    ...
    ![](./media/69bb15e804d37c2097ed0de61aad79b6fbbad405.png)
...
10. Assign the following roles and click on the **Save** button:
...
2.  Open the David Flores user account by selecting the user name.
